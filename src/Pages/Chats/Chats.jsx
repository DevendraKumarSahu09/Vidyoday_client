...
const Chats = () => {
  ...
  const fetchChats = async () => {
    try {
      ...
      // const { data } = await axios.get("https://vidyoday-server.onrender.com/chat");
          ...
          <div className="tabs">
            <Button
              ...
              style={{
                ...
                borderBottom: "none",
                backgroundColor: showChatHistory ? "var(--dark-color)" : "white",
                color: showChatHistory ? "white" : "var(--dark-color)",
                cursor: "pointer",
                minWidth: "150px",
                padding: "10px",
            ...
            <Button
              ...
              style={{
                ...
                borderBottom: "none",
                backgroundColor: showChatHistory ? "white" : "var(--dark-color)",
                color: showChatHistory ? "var(--dark-color)" : "white",
                cursor: "pointer",
                minWidth: "150px",
                padding: "10px",
                borderRadius: "5px 5px 0 0",
                    ...
                    {chats.map((chat) => (
                      <ListGroup.Item
                        ...
                        style={{
                          ...
                          marginBottom: "10px",
                          padding: "10px",
                          backgroundColor: selectedChat?.id === chat?.id ? "var(--dark-color)" : "lightgrey",
                    ...
                    {requests.map((request) => (
                      <ListGroup.Item
                        ...
                        style={{
                          ...
                          padding: "10px",
                          backgroundColor:
                            selectedRequest && selectedRequest.id === request.id ? "var(--dark-color)" : "lightgrey",
                          borderRadius: "5px",
                        }}
                      >
                        {request.name}
          ...
          >
            ...
            {selectedChat && (
              <>
                ...
                <Button variant="info" style={{ padding: "10px 20px", borderRadius: "5px",color:"white", border:"none" ,backgroundColor:"red"}} onClick={handleScheduleClick}>
                  Request Video Call
                </Button>
              </>
            )}
          ...
          <div style={{ flex: "7", position: "relative", height: "calc(100vh - 160px)" }}>
                  ...
                  {chatMessages.map((message, index) => {
                    ...
                    return (
                      ...
                      >
                        <div
                          style={{
                            backgroundColor: message.sender._id === user._id ? "var(--dark-color)" : "#d1d1d1",
                ...
                <>
                  {chatMessageLoading ? (
                    ...
                    <div className="row w-100 h-100 d-flex justify-content-center align-items-center">
                      <div className="text row w-100 d-flex justify-content-center align-items-center">
            ...
            {selectedChat && (
              ...
              >
                ...
                />
                <Button variant="success" style={{ padding: "10px 20px", borderRadius: "5px", border:"none" ,backgroundColor:"var(--primary-color)"}} onClick={sendMessage}>
                  Send
                </Button>
              </div>
            )}
        ...
        >
          ...
          >
            ...
            <Form>
              ...
              <Button
                variant="success"
                style={{ padding: "7px 15px", borderRadius: "5px", border:"none" ,backgroundColor:"var(--primary-color)"}}
                type="submit"
                onClick={async (e) => {
                  e.preventDefault();
