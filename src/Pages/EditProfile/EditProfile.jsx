        ...
        <div className="register_section mb-3">
          ...
          >
            <Tab eventKey="registration" title="Registration">
              {/* Name */}
              <div>
                <label style={{ color: "var(--dark-color)" }}>Name</label>
                <br />
                <input
                  type="text"
                  name="username"
              ...
              <div className="mt-3">
                <label style={{ color: "var(--dark-color)" }}>Profile Photo</label>
                <br />
                <input type="file" accept="image/*" onChange={handleFileChange} />
              </div>
              {/* Email */}
              <div>
                <label className="mt-3" style={{ color: "var(--dark-color)" }}>
                  Email
                </label>
                <br />
                <input
              ...
              <div>
                ...
                <button className="btn btnd mt-3 ms-1" name="skill_proficient_at" onClick={handleAddSkill}>
                  Add Skill
                </button>
              </div>
              {/* Skills to learn */}
              <div>
                <label style={{ color: "var(--dark-color)", marginTop: "20px" }}>Skills To Learn</label>
                <br />
                <Form.Select
                  aria-label="Default select example"
                  value={skillsToLearn}
                ...
                <button className="btn btnd mt-3 ms-1" name="skill_to_learn" onClick={handleAddSkill}>
                  Add Skill
                </button>
              </div>
              <div className="row m-auto d-flex justify-content-center mt-3">
                <button className="btn btnw" onClick={handleSaveRegistration} disabled={saveLoading}>
                  {saveLoading ? <Spinner animation="border" variant="primary" /> : "Save"}
                </button>
                <button onClick={handleNext} className="mt-2 btn btnd">
                  Next
                </button>
              </div>
            </Tab>
            <Tab eventKey="education" title="Education">
              {form?.education?.map((edu, index) => (
                <div className="border border-dark rounded-1 p-3 m-1" key={edu?._id}>
                  ...
                  <label style={{ color: "var(--dark-color)" }}>Institution Name</label>
                  <br />
                  <input
                    type="text"
                    name="institution"
                  ...
                  />
                  <label className="mt-2" style={{ color: "var(--dark-color)" }}>
                    Degree
                  </label>
                  <br />
                  <input
              ...
              <div className="row m-auto d-flex justify-content-center mt-3">
                <button className="btn btnw" onClick={handleSaveEducation} disabled={saveLoading}>
                  {saveLoading ? <Spinner animation="border" variant="primary" /> : "Save"}
                </button>
                <button onClick={handleNext} className="mt-2 btn btnd">
                  Next
            ...
            <Tab eventKey="longer-tab" title="Additional">
              <div>
                <label style={{ color: "var(--dark-color)", marginTop: "20px" }}>Bio (Max 500 Character)</label>
                <br />
                <textarea
                  name="bio"
                  value={form.bio}
              ...
              <div className="">
                <label style={{ color: "var(--dark-color)" }}>Projects</label>
                ...
                {form?.projects?.map((project, index) => (
                  <div className="border border-dark rounded-1 p-3 m-1" key={project?._id}>
                    ...
                    <label style={{ color: "var(--dark-color)" }}>Title</label>
                    <br />
                    <input
                      type="text"
                      name="title"
              ...
              <div className="row m-auto d-flex justify-content-center mt-3">
                <button className="btn btnw" onClick={handleSaveAdditional} disabled={saveLoading}>
                  {saveLoading ? <Spinner animation="border" variant="primary" /> : "Save"}
                </button>
